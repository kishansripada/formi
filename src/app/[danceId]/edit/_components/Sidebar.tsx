...
export const Sidebar: React.FC<{
   ...
   return (
      <div
         ...
         className="md:flex  flex-col hidden  h-full py-4  items-center   text-[10px] dark:bg-neutral-900  text-black bg-neutral-50  gap-4   w-20 min-w-[70px] max-w-[70px] border-r border-neutral-300 dark:border-neutral-700 overflow-y-scroll overflow-x-hidden removeScrollBar"
      >
         ...
         >
            ...
            {/* <p className="bg-pink-600 py-[0.5px] px-2 text-white rounded-full  mt-1">NEW</p> */}
         </button>
         {/* <button
            className="flex flex-col items-center dark:text-neutral-400 font-semibold text-neutral-600   "
            onClick={() => {
         ...
         >
            <svg
               ...
               stroke="currentColor"
               className={`w-7 h-7 transition duration-300  ml-auto mr-auto ${
                  menuOpen === "formationideas" ? "stroke-pink-600" : "dark:stroke-neutral-400 stroke-neutral-400"
               }`}
            >
               <path
                  strokeLinecap="round"
