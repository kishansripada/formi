...
export const Sidebar: React.FC<{
   ...
   return (
      <div
         ...
         className="md:flex  flex-col hidden  h-full  items-center   text-[10px] dark:bg-black  text-black bg-neutral-100  child:mb-5   w-20 min-w-[80px] border-r border-neutral-300 dark:border-neutral-700 overflow-y-scroll overflow-x-hidden"
      >
