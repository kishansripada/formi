...
export const DancerAlias: React.FC<{
   ...
   coordsToPosition: (coords: { x: number; y: number }) => { left: number; top: number } | null;
               ...
               style={{
                  transform:
                     item.side === "bottom"
                        ...
                        ? "translateY(0%) translateX(-50%)"
                        : "translateY(-50%)",
                  width: PIXELS_PER_SQUARE * (item.width || 1),
               }}
         ...
         {dancer.shape === "square" ? (
            ...
            >
               <path
                  ...
                  fill={color || dancer?.color || "#db2777"}
                  stroke={
                     amSelected && !isPlaying ? (localSettings.isDarkMode ? "white" : "#404040") : hexToRGBA(color || dancer?.color || "#db2777", 0.5)
                  }
                  strokeWidth={amSelected ? 20 : 8}
            ...
            >
               <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 366 317">
                  <path
                     ...
                     fill={color || dancer?.color || "#db2777"}
                     stroke={
                        amSelected && !isPlaying
                           ? localSettings.isDarkMode
                              ? "white"
                              : "#404040"
                           : hexToRGBA(color || dancer?.color || "#db2777", 0.5)
                     }
                     strokeWidth={amSelected ? 20 : 8}
