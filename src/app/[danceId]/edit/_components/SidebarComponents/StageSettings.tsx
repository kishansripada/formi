...
export const StageSettings: React.FC<{
   ...
   return (
      <VStack
         ...
         className=" text-xs h-full font-medium  dark:text-white overflow-y-scroll overflow-x-hidden "
      >
         <VStack className="">
            <HStack className="items-center justify-between gap-2 px-2 py-2 min-h-0">
               <p>Stage</p>
