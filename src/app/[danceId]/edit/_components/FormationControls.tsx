   ...
   return (
      <>
         <div
            ...
            className="w-full h-[40px] min-h-[40px] max-h-[40px]  border-t-neutral-300 border-t bg-white md:flex hidden flex-row items-center justify-between px-3 dark:bg-neutral-800 mt-auto dark:border-neutral-700 dark:text-white"
         >
