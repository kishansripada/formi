   ...
   return (
      <div className="flex flex-row items-center justify-center w-full h-full pb-10 overflow-hidden">
         ...
         <div className=" w-full h-full  border border-neutral-700 rounded-xl overflow-hidden ">
            {selectedRoster ? (
               <div className="w-full  overflow-scroll flex flex-col h-full ">
                  <div className="w-full h-10 border-b border-b-neutral-700 flex flex-row items-center px-3  ">
                     <input
                  ...
                  {selectedRoster.roster.map((dancer, index) => {
                     return (
                        <div className="flex flex-row items-center w-full h-16  px-6">
                  ...
                  <div className="w-full h-10 border-t border-t-neutral-700 flex flex-row items-center px-3 mt-auto ">
                     <button
                        onClick={async () => {
                           // delete roster
