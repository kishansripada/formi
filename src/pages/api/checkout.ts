...
const ProtectedRoute: NextApiHandler = async (req, res) => {
   ...
   let checkoutSession = await fetch("https://api.stripe.com/v1/checkout/sessions", {
      body: `success_url=https://formistudio.app/dashboard;line_items[0[price]=${req.query.price};line_items[0][quantity]=1;mode=subscription;customer=${customerId};subscription_data[trial_period_days]=7;cancel_url=https://formistudio.app/pricing`,
      headers: {
         Authorization:
            "Basic c2tfbGl2ZV81MUxhajV0SHZDM3c2ZThmY1llbTBoUGdQVFdKb29Sd3owMmpucW5iYlRpVXk2NkJTRE5UMjN6U1JQRDV3Tjg1QktRcVRBWFY5UENaTGNud2Joc2F5ZDdTVTAwVnNEVHZLWVI6",
         "Content-Type": "application/x-www-form-urlencoded",
