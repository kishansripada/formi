         ...
         <div className="bg-[#fafafa]">
            ...
            <div className="bg-white flex flex-col font-proxima items-center relative overflow-hidden px-[10%] text-gray-900 py-20">
               ...
               <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-1/2 rounded-xl mt-16 lg:mt-0   relative z-50 pointer-events-none select-none">
                     <Image className="object-contain w-full relative " layout="fill" src="/curveDemo.png" width={800} height={600} alt="" />
                  </div>
               </div>
            ...
            {/* FOOTER */}
            <div className="bg-[#fafafa] border-t-4 border-pink-600 pt-6 pb-6 px-12 ">
               <div className="w-[250px] pointer-events-none">
                  {/* <h1 className="text-6xl font-bold z-10 relative">naach.app</h1>
                     <div className="bg-pink-600 relative h-3 opacity-40 top-[-15px] mr-auto w-[58%]"></div> */}
                  <h1 className="text-6xl font-bold z-10 relative">FORMI</h1>
               ...
               <div className=" flex flex-row grayscale">
                  <a target={"_blank"} href="https://www.instagram.com/formistudio.app/">
                     <img
                  ...
                  <a target={"_blank"} href="https://www.linkedin.com/company/formistudio/">
                     <img
               ...
               <div className=" flex flex-row bg-[#fafafa] mt-12 ">
                  <p className="text-sm">© 2023 THE SRIPADA COMPANY, LLC. All Rights Reserved</p>
