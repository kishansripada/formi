   ...
   return (
      <>
         ...
         <div className="bg-[#fafafa]">
            ...
            <div className="bg-[#efefef] lg:flex-row  flex flex-col-reverse items-center justify-center lg:justify-between px-[5%] lg:px-[20%] pt-24 pb-24 font-proxima text-center lg:text-left">
               <div className="lg:w-[50%] relative lg:mr-20 grid place-items-center">
                  <img src="https://i.imgur.com/7DkjOvn.png" className="w-72" alt="" />
               </div>
               <div className="lg:w-[50%]">
                  <h1 className="font-semibold text-3xl text-gray-800 relative z-10 lg:w-[70%]">
                     drag and drop your dancers, then watch them come to life
                  </h1>
                  <div className="bg-blue-300 relative h-3 opacity-40 top-[-10px]"></div>
                  <p className="text-lg text-gray-400 lg:w-[70%] mt-3 font-light">
                     automatically determine if your dancers will <span className="font-bold text-gray-500 ">collide</span> on stage
                  </p>
               </div>
            </div>
            <div className="bg-[#efefef] flex flex-col lg:flex-row items-center justify-center lg:justify-between  px-[5%] lg:px-[20%] pt-24 pb-48 font-proxima text-center lg:text-left">
               <div className="lg:w-[50%]">
                  <h1 className="font-semibold text-3xl text-gray-800 relative z-10 lg:w-[70%]">
                     the only performance planner that's collaborative by nature
                  </h1>
                  <div className="bg-green-300 relative h-3 opacity-40 top-[-10px]"></div>
                  <p className="text-lg text-gray-400 lg:w-[70%] mt-3 font-light">
                     create with your choreographers and share with your dancers with just a link
                  </p>
               </div>
               <div className="lg:w-[50%] relative lg:mr-20 grid place-items-center">
                  <img src="https://i.imgur.com/7DkjOvn.png" className="w-72" alt="" />
            ...
            <div className="bg-[#efefef]">
               <div className="pt-6 pb-6 px-12 flex flex-row bg-[#efefef] ">
