...
const privacy = ({ session, setSession }: { session: Session; setSession: Function }) => {
   return (
      <div className="mx-[15%]">
         <div className="">
            <strong>
               ...
               <strong>
                  <span style={{ fontSize: 15 }}>
                     <span data-custom-class="subtitle">
                        Last updated <bdt className="question">September 17, 2022</bdt>
                     </span>
                  </span>
               </strong>
            </span>
            ...
            <span style={{ color: "rgb(127, 127, 127)" }}>
               <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     This privacy notice for <bdt className="question">Naach</bdt>
                     ...
                     ," "<strong>we</strong>," "<strong>us</strong>," or "<strong>our</strong>"<bdt className="statement-end-if-in-editor" />
                  </span>
                  <span data-custom-class="body_text">
                     ), describes how and why we might collect, store, use, and/or share (
                     <bdt className="block-component" />"<strong>process</strong>"
                     <bdt className="statement-end-if-in-editor" />) your information when you use our services (<bdt className="block-component" />"
         ...
         <div>
               ...
               <span style={{ fontSize: 15 }}>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                     <span data-custom-class="body_text">
                        ...
                        choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions
                        or concerns, please contact us at <bdt className="question">contact@naach.app</bdt>.
                     </span>
                  </span>
               </span>
            </div>
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     ...
                     information depending on how you interact with <bdt className="block-component" />
                     <bdt className="question">Naach</bdt>
                     <bdt className="statement-end-if-in-editor" /> and the Services, the choices you make, and the products and features you use.
                     Click&nbsp;
                  </span>
               </span>
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     <strong>Do we process any sensitive personal information?</strong> <bdt className="block-component" />
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     <strong>Do we receive any information from third parties?</strong> <bdt className="block-component" />
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     ...
                     organizational
                     <bdt className="statement-end-if-in-editor" /> and technical processes and procedures in place to protect your personal
                     information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100%
                     secure, so we cannot promise or guarantee that hackers, cybercriminals, or other <bdt className="block-component" />
                     unauthorized
                     <bdt className="statement-end-if-in-editor" /> third parties will not be able to defeat our security and improperly collect,
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     <strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                     ...
                     here:{" "}
                     <bdt className="question">
                        <a href="https://www.naach.app/myprofile" target="_blank" data-custom-class="link">
                           https://www.naach.app/myprofile
                        </a>
                     </bdt>
                     <bdt className="else-block" />, or by contacting us. We will consider and act upon any request in accordance with applicable data
                     protection laws.
                  </span>
               </span>
            </div>
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <a data-custom-class="link" href="#cookies">
                     <span style={{ color: "rgb(89, 89, 89)" }}>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</span>
                  </a>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                     <span style={{ color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
            ...
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <a data-custom-class="link" href="#DNT">
                     <span style={{ color: "rgb(89, 89, 89)" }}>9. CONTROLS FOR DO-NOT-TRACK FEATURES</span>
                  </a>
               </span>
            </div>
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <a data-custom-class="link" href="#caresidents">
                     <span style={{ color: "rgb(89, 89, 89)" }}>10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
                  </a>
               </span>
            </div>
            <div style={{ lineHeight: "1.5" }}>
               <span style={{ fontSize: 15 }}>
                  <a data-custom-class="link" href="#policyupdates">
                     <span style={{ color: "rgb(89, 89, 89)" }}>11. DO WE MAKE UPDATES TO THIS NOTICE?</span>
                  </a>
               </span>
            </div>
            <div style={{ lineHeight: "1.5" }}>
               <a data-custom-class="link" href="#contact">
                  <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
               </a>
            </div>
            <div style={{ lineHeight: "1.5" }}>
               <a data-custom-class="link" href="#request">
                  <span style={{ color: "rgb(89, 89, 89)" }}>13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span>
               </a>
            </div>
            <div style={{ lineHeight: "1.5" }}>
               <br />
               ...
               <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                     ...
                     <span style={{ fontSize: 15 }}>
                        ...
                        <span data-custom-class="body_text">
                           express an interest in obtaining information about us or our products and Services, when you participate in activities on
               ...
               <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                     <span data-custom-class="body_text">
                        ...
                        social media account details, like your Facebook, Twitter, or other social media account. If you choose to register in this
                        way, we will collect the information described in the section called <bdt className="block-component" />"
                        <bdt className="statement-end-if-in-editor" />
                        <span style={{ fontSize: 15 }}>
                           <span data-custom-class="body_text">
                              <span style={{ fontSize: 15 }}>
                  ...
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                     <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                        <span data-custom-class="body_text">
                           ...
                           We may process your information so you can create and log in to your account, as well as keep your account in working
                           order.
                           <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                                 <span data-custom-class="body_text">
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         Facebook or Twitter logins). Where you choose
                                                                                                         ...
                                                                                                         your name, email address, friends list, and
                                                                                                         profile picture, as well as other information
                                                                                                         you choose to make public on such a social
                                                                                                         media platform.{" "}
                                                                                                         <span
                                                                                                            style={{
                                                                                                               fontSize: 15,
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         <bdt className="block-component" /> which may
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         tracking is adopted that we must follow in
                                                                                                         the future, we will inform you about that
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         "resident"
                                                                                                         <bdt className="statement-end-if-in-editor" />{" "}
                                                                                                         applies to you, we must adhere to certain
                                                                                                         rights and obligations regarding your
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         authorized
                                                                                                         <bdt className="statement-end-if-in-editor" />{" "}
                                                                                                         agent to exercise your right to opt out we
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      ...
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         or commercial purpose in the preceding twelve
                                                                                                         (12) months.{" "}
                                                                                                         <span
                                                                                                            style={{
                                                                                                               color: "rgb(89, 89, 89)",
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         law, such as (but not limited to) the
                                                                                                         exercise by another consumer of his or her
                                                                                                         right to free speech, our compliance
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         make material changes to this privacy notice,
                                                                                                ...
                                                                                                >
                                                                                                   ...
                                                                                                   >
                                                                                                      ...
                                                                                                      <span data-custom-class="body_text">
                                                                                                         ...
                                                                                                         <bdt className="question">
                                                                                                            <a
                                                                                                               href="https://www.naach.app/myprofile"
                                                                                                               target="_blank"
                                                                                                               data-custom-class="link"
                                                                                                            >
                                                                                                               https://www.naach.app/myprofile
