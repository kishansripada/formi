...
export const EditDancer: React.FC<{ setEditingDancer: Function; editingDancer: string | null; dancers: dancer[]; setDancers: Function }> = ({
   setEditingDancer,
   editingDancer,
   dancers,
   setDancers,
      ...
      >
         <div className="flex  w-[400px] flex-col rounded-xl bg-white pt-10 pb-3 px-3">
            ...
            <div className="flex flex-col mt-auto">
               ...
               <button
                  className="bg-red-600 flex flex-row mt-6 text-white px-2 py-1 rounded-md ml-auto"
                  onClick={() => {
                     setEditingDancer(null);
                     setDancers((dancers: dancer[]) => {
                        return dancers.filter((dancer) => editingDancer !== dancer.id);
                     });
                  }}
               >
