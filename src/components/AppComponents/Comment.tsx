   ...
   return (
      <>
         ...
         <div
            ...
            }    bg-gray-800 group select-none shadow-xl   transition ease-in-out duration-300  lg:pointer-events-auto pointer-events-none flex    flex-row   items-center absolute z-[300]  cursor-default `}
         >
