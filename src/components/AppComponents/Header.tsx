         ...
         <div className=" min-h-[50px] bg-neutral-800 flex flex-row items-center w-full  text-white border-b border-neutral-700 ">
            <div className="flex flex-row items-center justify-start w-1/3 h-full">
               ...
               <button
                  ...
                  className=" h-full w-12 grid place-items-center "
               >
               ...
               <button
                  onClick={() =>
                     setLocalSettings((localSettings: localSettings) => {
                        return { ...localSettings, viewingTwo: !localSettings.viewingThree ? true : !localSettings.viewingTwo };
                     })
                  }
               ...
               <button
                  onClick={() =>
                     setLocalSettings((localSettings: localSettings) => {
                        return { ...localSettings, viewingThree: !localSettings.viewingTwo ? true : !localSettings.viewingThree };
                     })
                  }
