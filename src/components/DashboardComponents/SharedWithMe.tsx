...
export const SharedWithMe: React.FC<{ sharedWithMe: any }> = ({ sharedWithMe }) => {
   ...
   return (
      <>
         ...
         <div className="w-full flex flex-col lg:items-start lg:flex-row overflow-y-visible  overflow-x-scroll mt-7 removeScrollBar h-full overscroll-contain items-center">
            {sharedWithMe.length ? (
               sharedWithMe
               ...
               <p>Looks like you don't have any dances shared with you</p>
            )}
         </div>
      </>
   );
