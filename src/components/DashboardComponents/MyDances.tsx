...
export const MyDances: React.FC<{ myDances: any; invalidateDances: Function }> = ({ myDances, invalidateDances }) => {
                        ...
                        <>
                           <div className="flex flex-col items-center text-gray-700 mr-5 relative cursor-pointer  ">
                              <Link key={dance.id} href={`/${dance.id}/edit`}>
                                 <div className="">
                                    <div className="bg-white rounded-xl h-[200px] w-[350px] relative border-gray-500 border  ">
                              ...
                              {openPerformanceMenu === dance.id ? <Dropdown invalidateDances={invalidateDances} dance={dance}></Dropdown> : null}
                           </div>
                        </>
                     );
                  })
