...
export const PricingTable = ({ session }) => {
               ...
               <section className="bg-white  dark:bg-neutral-900">
                  <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
                     ...
                     <div className="flex flex-row  ">
                        <div className="flex flex-col px-10 py-10  flex-grow   text-neutral-900 bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-600 border-neutral-100 shadow mr-5 lg:w-1/2 ">
                        ...
                        {/* Pricing Card */}
                        <div className="flex flex-col px-10 py-10  flex-grow   text-neutral-900 bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-600 border-neutral-100 shadow ml-5 lg:w-1/2 ">
                           <h3 className="mb-4 text-2xl font-semibold dark:text-neutral-100">Pro</h3>
                           <p className="font-light text-neutral-500  dark:text-neutral-300 text-sm ">
                              For dance teams looking to use FORMI full-time
                           </p>
                           <div className="flex  items-baseline my-8">
                              <span className="mr-2 text-4xl font-extrabold dark:text-neutral-100">$12</span>
                        ...
                        <div className="flex flex-col px-10 py-10  flex-grow   text-neutral-900 bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-600 border-neutral-100 shadow ml-5 lg:w-1/2 ">
                           ...
                           <div className="flex  items-baseline my-8">
                              <span className="mr-2 text-4xl font-extrabold dark:text-neutral-100">$99</span>
                              <span className="text-neutral-500 dark:text-neutral-300 ">/month</span>
                           </div>
                           {/* List */}
                           <ul role="list" className="mb-8  text-left">
                              {["Collaborative editing", "FORMI Teams", "Custom watermark", "Custom branding", "Priority support"].map(
                                 (featureDescription) => {
                                    return (
                                       <li className="flex items-center mb-3 text-sm space-x-3">
                                          <svg
