      ...
      >
         ...
         >
            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 777 621">
               ...
               <rect width="612" height="454" x="165" stroke="white" strokeWidth="158" mask="url(#a)" rx="62" />
               <path fill="white" fillRule="evenodd" d="M629 542H79V119H0v440c0 34.242 27.758 62 62 62h567v-79Z" clipRule="evenodd" />
            </svg>
